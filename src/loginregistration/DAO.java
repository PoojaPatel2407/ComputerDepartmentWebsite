...
public class DAO {
	...
	public boolean AvailNetID(String netid, String role) {

		String query = "";
		if (role.equals("student"))
			query = "select * from studentdetails where netid = '" + netid + "'";
		else
			query = "select * from facultystaffdetails where netid = '" + netid + "'";
	...
	/*
	 * public ArrayList<GetProfileModel> getStudentProfile(String netid) throws
	 * SQLException {
	 * 
	 * String query = "select * from student where Netid='" + netid + "';";
	 * ResultSet rs = s.executeQuery(query); ArrayList<GetProfileModel> profile
	 * = new ArrayList<GetProfileModel>();
	 * 
	 * while (rs.next()) { GetProfileModel gpm = new
	 * GetProfileModel(rs.getString("Netid"), rs.getString("Fname"),
	 * rs.getString("Lname"), rs.getString("Year"), rs.getString("Major"),
	 ...
	 * }
	 * 
	 * public ArrayList<GetProfileModel> getFacultyProfile(String netid) throws
	 * SQLException {
	 * 
	 ...
	 * while (rs.next()) { GetProfileModel gpm = new
	 * GetProfileModel(rs.getString("Netid"), rs.getString("Fname"),
	 * rs.getString("Lname"), "null", "null", "null"); profile.add(gpm); }
	 * 
	 * return profile;
	 * 
	 * }
	 * 
	 * public ArrayList<GetProfileModel> getStaffProfile(String netid) throws
	 * SQLException {
	 * 
	 ...
	 * }
	 * 
	 * public boolean updateStudentProfile(String netid, String password, String
	 * fname, String lname, String year, String program, String major, String
	 * advisorname, String advisornumber, String advisoremail) throws
	 * SQLException {
	 * 
	 * String query = "update student set Fname='" + fname + "', Lname='" +
	 * lname + "', Year='" + year + "', Program='" + program + "', Major='" +
	 * major + "', Advisorname='" + advisorname + "', Advisornumber='" +
	 * advisornumber + "', Advisoremail='" + advisoremail + "' where Netid='" +
	 * netid + "';";
	 * 
	 * if (s.executeUpdate(query) == 1) { query = "update login set Password='"
	 * + password + "' where Netid='" + netid + "';"; if (s.executeUpdate(query)
	 * == 1) { return true; } }
	 * 
	 * return false; }
	 * 
	 * public boolean updateFacultyProfile(String netid, String password, String
	 ...
	 * return false; }
	 * 
	 * public boolean updateStaffProfile(String netid, String password, String
	 * fname, String lname) throws SQLException {
	 * 
	 * String query = "update staff set Fname='" + fname + "', Lname='" + lname
	 * + "' where Netid='" + netid + "';";
	 * 
	 * if (s.executeUpdate(query) == 1) { query = "update login set Password='"
	 * + password + "' where Netid='" + netid + "';"; if (s.executeUpdate(query)
